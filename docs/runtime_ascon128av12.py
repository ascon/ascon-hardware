...
cycles += (8//Urol+4)*Na                   # absorb + process complete AD blocks
cycles += Ina*((Bla+3)//4+(8//Urol))       # absorb + process incomplete AD block
...
cycles += (8//Urol+4)*Nm                   # absorb + process complete MSG blocks
...
cycles += 1                                # domain seperation
cycles += (8//Urol+4)*Nc                   # absorb + process complete MSG blocks
